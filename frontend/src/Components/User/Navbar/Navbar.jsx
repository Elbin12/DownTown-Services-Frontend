...
function Navbar({onLoginClick}) {
  return (
    <div class='flex justify-between w-screen bg-white h-28 items-center pl-20 pr-20'>
      ...
      <Searchbar />
      <div className="login-button" class='p-4 h-14 items-center flex bg-gradient-to-r from-[#3E6990CC] to-[#3E6990] rounded-lg text-white cursor-pointer' onClick={onLoginClick}>
