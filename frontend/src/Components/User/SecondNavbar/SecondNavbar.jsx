...
function SecondNavbar({role}) {
  ...
  return (
    <div className='bg-[#ede9dc]  justify-center mt-24 gap-2  sm:gap-9 fixed w-full flex flex-row text-[#4F4E4E] text-xs sm:text-sm font-normal'>
        ...
        <h6 className={`p-2 sm:p-3 cursor-pointer ${window.location.pathname.includes('wallet')&&'bg-[#dcce9b65] font-semibold'}`} onClick={()=>{navigate('/wallet/')}}>Wallet</h6>
